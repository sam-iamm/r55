...
pub const PENDLE_YIELD_TOKEN_BYTECODE: &[u8] = include_bytes!("../../../r55-output-bytecode/pendle-yield-token.bin");
...
pub const SY_ERC20_BYTECODE: &[u8] = include_bytes!("../../../r55-output-bytecode/sy-erc20.bin");
...
pub const PENDLE_PRINCIPAL_TOKEN_BYTECODE: &[u8] = include_bytes!("../../../r55-output-bytecode/pendle-principal-token.bin");
...
pub fn get_bytecode(contract_name: &str) -> Bytes {
    let initcode = match contract_name {
        ...
        "pendle_principal_token" => PENDLE_PRINCIPAL_TOKEN_BYTECODE,
